...
export default function Main() {
  return (
    <div className="min-h-[92vh] relative flex flex-col justify-center items-center" id="home">
      {/* DotMesh absolutely positioned behind logo */}
      <div className="absolute inset-0 overflow-clip z-0 pointer-events-none">
              <DotMesh />
            </div>
            ...
            <div className="absolute bottom-0 w-full flex flex-col items-center z-10">
              <div className="mb-4">
                <Link
