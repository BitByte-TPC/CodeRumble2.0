export default function PerksCard({ head, text }) {
  return (
    <div className="flex flex-col gap-10 bg-[#FFFFFF1A] rounded-3xl md:rounded-[2.5rem] p-7 md:p-8 xl:p-10 md:pr-15 lg:pr-15 xl:pr-32 md:h-80 w-48 md:w-[100%] md:mb-0 border-[1px] border-solid border-[rgba(255, 255, 255, 0.05)]">
