...
const Footer = () => (
  <>
    <div className="flex flex-col justify-center align-middle md:grid md:grid-cols-3 md:grid-rows-2 2xl:grid-rows-3 gap-3 md:gap-0 pb-5 md:pb-0 grid-flow-row h-full">
